...
- **[docs/TODO.md](docs/TODO.md) — the consolidated implementation checklist.**
  Everything the three documents above call for that does not exist in the code
  yet, in dependency order. Start here.
