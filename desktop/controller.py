...
class PipelineClient:
    ...
    def set_complexion_target_base(self, base: str) -> Dict[str, Any]:
        """Set the target's own tone (auto, or a Monk Skin Tone step mst01-mst10)."""
        return self.set_realism(complexion_target_base=base)
